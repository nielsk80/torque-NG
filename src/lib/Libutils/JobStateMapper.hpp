 ...
 * @brief Utility to map between legacy Torque string/char states and Protobuf
 * Enums.
 */
class JobStateMapper {
public:
  /**
   * Converts a string (e.g., "R", "RUNNING", "Q") to a torque_ng::Job::JobState
   * enum.
   * @param state_str The input state string.
   * @return The corresponding JobState enum value. Defaults to TRANSIT if
   * unknown.
   */
